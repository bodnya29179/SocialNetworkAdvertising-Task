...
@Component({
  selector: 'app-performer-header',
  templateUrl: './performer-header.component.html',
  styleUrls: ['./performer-header.component.css']
})

/* Module view using class. */
export class PerformerHeaderComponent implements OnInit {
